...
import (
	"context"
	lanpangziv1 "operator_demo/code_generator_demo/pkg/apis/lanpangzi/v1"
	versioned "operator_demo/code_generator_demo/pkg/generated/clientset/versioned"
	internalinterfaces "operator_demo/code_generator_demo/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "operator_demo/code_generator_demo/pkg/generated/listers/lanpangzi/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LanpangziV1().Guestbooks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LanpangziV1().Guestbooks(namespace).Watch(context.TODO(), options)
			},
		},
		&lanpangziv1.Guestbook{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *guestbookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lanpangziv1.Guestbook{}, f.defaultInformer)
}
